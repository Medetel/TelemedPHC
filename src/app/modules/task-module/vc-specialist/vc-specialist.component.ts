...
@Component({
  selector: 'app-vc-specialist',
  templateUrl: './vc-specialist.component.html',
  styleUrls: ['./vc-specialist.component.scss']
})
export class VcSpecialistComponent implements OnInit {
  @Pipe({ name: 'safe' })
