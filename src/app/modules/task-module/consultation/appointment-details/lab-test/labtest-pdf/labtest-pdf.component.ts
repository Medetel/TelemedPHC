...
@Component({
  selector: 'app-labtest-pdf',
  templateUrl: './labtest-pdf.component.html',
  styleUrls: ['./labtest-pdf.component.scss']
})
export class LabtestPdfComponent implements OnInit {
  do_reg_no: any;
  imageUrl2: any;
  mainData: any;
  childData: any;
  ...
  constructor(@Inject(MAT_DIALOG_DATA) private _data: any, private service: CounsultationService, private http: HttpClient) { }
