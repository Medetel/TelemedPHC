...
export class ConsultationHistoryComponent implements OnInit {
  ...
  TooltipPosition:TooltipPosition[] = ['above'];
    constructor(public dialog: MatDialog,private http:HttpClient, private service:ConsultationHistoryService) { }
    ...
    view(d:any) {
      const dialogRef = this.dialog.open(ConsultationViewComponent,
        {
          height: '100%',
          width: '100%',
          data: {d}
