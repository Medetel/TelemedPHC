...
@Component({
  selector: 'app-suggest-dietplan',
  templateUrl: './suggest-dietplan.component.html',
  styleUrls: ['./suggest-dietplan.component.scss']
})
export class SuggestDietplanComponent implements OnInit {
  do_reg_no: any;
  imageUrl2: any;
  mainData: any;
  childData: any;
  ...
  download() {
    ...
    html2canvas(element, {
      ...
      const Filename = "Dietplan-" + this._data.d.coN_Id + ".pdf";
      doc.save(Filename);
    });
  }

  constructor(@Inject(MAT_DIALOG_DATA) private _data: any, private service: DietplanInfoService, private http: HttpClient) { }
  ...
  // }
  ngOnInit(): void {
    this.service.GetbyId_dietplan(this._data.d.coN_Id).subscribe((data: any) => {
      this.mainData = data;
      ...
      this.coN_PR_Id_FK = this.mainData[0].coN_PR_Id_FK;
      this.coN_DO_Name = this.mainData[0].coN_DO_Name;
      this.coN_PR_Age = this.mainData[0].coN_PR_Age;
      this.coN_PR_Code = this.mainData[0].coN_PR_Code;
      this.coN_PR_Name = this.mainData[0].coN_PR_Name;
      this.coN_Date = this.mainData[0].coN_Date;
      this.childData = data[0].getalldietplanlist;
      this.imageUrl = this.mainData[0].hospital_Logo;
      ...
      this.page_title = 'Dietplan' + '-' + 'ConsId' + this.coN_Id + '-' + 'PId' + this.coN_PR_Id_FK;;
