...
@Component({
  selector: 'app-suggest-prescription',
  templateUrl: './suggest-prescription.component.html',
  styleUrls: ['./suggest-prescription.component.scss']
})
export class SuggestPrescriptionComponent implements OnInit {
  do_reg_no: any;
  imageUrl2: any;
  mainData: any;
  childData: any;
  ...
  constructor(@Inject(MAT_DIALOG_DATA) private _data: any, private service: PharmacyInfoService) { }
