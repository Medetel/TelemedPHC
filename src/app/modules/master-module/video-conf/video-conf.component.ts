...
//vital signs
  ...
  constructor(private sanitizer:DomSanitizer,private route: ActivatedRoute,private fb: FormBuilder,private activatedRoute: ActivatedRoute, public router:Router,private userService: CounsultationService, private vcService:VideoConfService) { }
  ...
  getConsultation_Patient_DD() {   
   ...
   {      
      ...
      this.cons_id=res[1]; //consl id
        ...
        .subscribe((data) => {
          this.result=data;          
          console.log('patient data :' +JSON.stringify(this.result))
          //patient details
   ...
   console.log('fname :' +this.firstName)
      ...
      this.vcService.startMeeting(passdata)
      .subscribe((data) => {
      this.vcData=data;
