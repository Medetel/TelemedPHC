...
@Component({
  selector: 'app-add-callcenter',
  templateUrl: './add-callcenter.component.html',
  styleUrls: ['./add-callcenter.component.scss']
})
export class AddCallcenterComponent implements OnInit {
  hospitaldd: any;
  qualificationdd: any;
  designationdd: any;
  specilizationdd: any;
  ...
  constructor(private service: CallcenterService, private router: Router, private notif: Notification, public dialog: MatDialog) { }
  ...
  save() {
    ...
    this.service.Post_Callcenter(formdata)
      .subscribe((res) => {
        this.notif.successmsg("Callcenter Agent Added Successfully")
        this.router.navigate(['/base/master/support-agent']);
      })
  }
  ...
  get_hospitaldd() {
    this.service.Get_HospitalDD()
      .subscribe((data:any) => {
        ...
        this.hospitaldd = data.filter(hospital => hospital.hos_Id === 2363);
      })
  }
  get_qualificationdd() {
