...
@Component({
  selector: 'app-total-groups',
  templateUrl: './total-groups.component.html',
  styleUrls: ['./total-groups.component.scss']
})
export class TotalGroupsComponent implements OnInit {
  dtOptions = {};
  constructor() { }
data=[
